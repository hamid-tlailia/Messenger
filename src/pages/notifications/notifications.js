...
const Notifications = () => {
  ...
  return (
    <div className="container-fluid all-center-col notifs-parent ">
      ...
      <div className="notifs w-100">
        ...
        <div className="notif-content mb-4 d-flex flex-row w-100 justify-content-center align-items-center gap-4">
          <NavLink to="/posts/details/cc8p22df8pll6">
            <img
              src={userThree}
